...
namespace ZonaRTX.data
{
    public class DetallesPedidosRepository : IBaseRepository<DetallesPedidosModel>
    {
        ...
        public async Task<IEnumerable<DetallesPedidosModel>> GetAllAsync()
        {
            ...
            const string sql = "SELECT * FROM DetallePedidos";
        ...
        {
            using var connection = _db.GetConnection();
            const string sql = "SELECT * FROM DetallePedidos WHERE id_detalle = @id";
        ...
        {
            using var connection = _db.GetConnection();
            const string sql = @"INSERT INTO DetallePedidos (id_pedido, id_producto, cantidad, precio_unitario)
        ...
        {
            using var connection = _db.GetConnection();
            const string sql = @"UPDATE DetallePedidos
        ...
        {
            using var connection = _db.GetConnection();
            const string sql = "DELETE FROM DetallePedidos WHERE id_detalle = @id";
